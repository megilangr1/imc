...
class HibahBansos extends Component
{
    // Form State
    public $state = [];
    ...
    {
        return view('livewire.pencairan.hibah-bansos');
    }
    ...
    public function doCreate()
    {
        ...
        try {
            ...
            $data = Pengajuan::firstOrCreate([
                ...
                'kode_jenis_pengajuan' => 'ls-hibah-dan-bansos',
                'nama_jenis_pengajuan' => 'LS - Hibah dan Bansos',
            ...
            $dokumenState = (new MainHelper)->dokumenState['ls-hibah-dan-bansos'];
            ...
            return $this->redirect(route('pencairan.hibah-bansos.detail', ['uuid' => $data->uuid]), navigate: true);
        } catch (\Throwable $th) {
            DB::rollBack();
            (new MainHelper)->doAlert($this);
            dd($th);
