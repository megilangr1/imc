...
class GajiJkkJkmBpjs extends Component
{
    // Form State
    public $state = [];
    ...
    public function getStaticData()
    {
        try {
            ...
            $this->staticData['jenis_pembayaran'] = [
                'Gaji PNS',
                'P3K',
                'JKK',
                'JKM',
    ...
    public function setState()
    {
        if (isset($this->editData)) {
            $this->state = [
                ...
                'jenis_pembayaran' => $this->editData->jenis_pembayaran,
    ...
    {
        return view('livewire.pencairan.gaji-jkk-jkm-bpjs');
    }
    ...
    public function doCreate()
    {
        $this->validate([
            ...
            'state.jenis_pembayaran' => 'required|string',
            ...
            'state.jenis_pembayaran' => 'Jenis Pembayaran',
        ...
        try {
            ...
            $data = Pengajuan::firstOrCreate([
                ...
                'kode_jenis_pengajuan' => 'gaji-jkk-jkm-bpjs',
                'nama_jenis_pengajuan' => 'Gaji / JKK / JKM / BPJS',
                ...
                'jenis_pembayaran' => $this->state['jenis_pembayaran'] ?? null,
            ...
            $dokumenState = (new MainHelper)->dokumenState['gaji-jkk-jkm-bpjs'];
            ...
            return $this->redirect(route('pencairan.gaji-jkk-jkm-bpjs.detail', ['uuid' => $data->uuid]), navigate: true);
        } catch (\Throwable $th) {
            DB::rollBack();
            (new MainHelper)->doAlert($this);
            dd($th);
