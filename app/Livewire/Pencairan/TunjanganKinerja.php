...
class TunjanganKinerja extends Component
{
    // Form State
    public $state = [];
    ...
    {
        return view('livewire.pencairan.tunjangan-kinerja');
    }
    ...
    public function doCreate()
    {
        ...
        try {
            ...
            $data = Pengajuan::firstOrCreate([
                ...
                'kode_jenis_pengajuan' => 'tunjangan-kinerja',
                'nama_jenis_pengajuan' => 'Tunjangan Kinerja (TUKIN)',
            ...
            $dokumenState = (new MainHelper)->dokumenState['tunjangan-kinerja'];
            ...
            return $this->redirect(route('pencairan.tunjangan-kinerja.detail', ['uuid' => $data->uuid]), navigate: true);
        } catch (\Throwable $th) {
            DB::rollBack();
            (new MainHelper)->doAlert($this);
            dd($th);
