...
@section('content')
    <!-- HERO -->
    <section class="hero min-h-[70vh] bg-cover bg-center" style="background-image: url('{{ asset('img/banner-2.jpg') }}')">
        <div class="hero-overlay bg-opacity-50"></div>
        <div class="container mx-auto px-4 text-center text-white">
            <h1 class="text-4xl md:text-6xl font-bold leading-tight">Solusi Digital Terpercaya untuk Bisnis
                Modern</h1>
            ...
            <div class="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="#products" class="btn btn-ghost btn-lg max-w-xs">Layanan Kami</a>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="py-16 bg-base-200">
        <div class="container mx-auto px-4 max-w-3xl text-center">
            ...
            <div class="grid grid-cols-1 gap-8 mt-10 text-left">
                <div class="bg-emerald-500 rounded-lg shadow p-6 text-center">
