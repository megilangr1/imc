<div class="flex flex-col gap-3">
    <x-main.page-header
        title="Formulir Permohonan Pengajuan Pencairan - Uang Persediaan (UP) / Ganti Uang (GU) | {{ isset($editData) ? 'Ubah Data' : 'Tambah Data' }}">
                    ...
                    <div class="w-full grid grid-cols-12 px-4 gap-3">
                        ...
                        <div class="col-span-12 md:col-span-12 lg:col-span-3">
                            <label for="jenis_belanja"
                                class="block text-sm font-medium mb-2 {{ $errors->has('state.jenis_belanja') ? 'text-red-500' : '' }}">
                                Jenis Belanja :
                            </label>
                            <div class="relative">
                                <select wire:model="state.jenis_belanja" id="jenis_belanja" name="jenis_belanja"
                                    class="w-full select @error('state.jenis_belanja') select-error @enderror"
                                    aria-describedby="jenis_belanja-helper" placeholder="Masukan Jenis Belanja..."
                                    required autocomplete="false">
                                    <option disabled>Pilih Jenis Belanja</option>
                                    @foreach ($staticData['jenis_belanja'] as $item)
                                        <option value="{{ $item }}">{{ $item }}</option>
                                    @endforeach
                                </select>
                                <div
                                    class="absolute inset-y-0 end-6 {{ $errors->has('state.jenis_belanja') ? 'flex' : 'hidden' }} items-center pointer-events-none pe-3">
                                    <svg class="shrink-0 size-4 text-red-500" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                            ...
                            @error('state.jenis_belanja')
                                <p class="text-xs text-red-600 mt-1" id="jenis_belanja-helper">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-12 md:col-span-12 lg:col-span-3">
                            ...
                            <div class="relative">
                                <select wire:model="state.bulan" id="bulan" name="bulan"
                                    ...
                                    aria-describedby="bulan-helper" placeholder="Masukan Bulan..." required
                                    autocomplete="false">
