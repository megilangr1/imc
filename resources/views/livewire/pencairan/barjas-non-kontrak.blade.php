<div class="flex flex-col gap-3">
    <x-main.page-header
        title="Formulir Permohonan Pengajuan Pencairan - LS Barang dan Jasa (Non Kontrak) | {{ isset($editData) ? 'Ubah Data' : 'Tambah Data' }}">
            ...
            <form wire:submit="actionForm">
                <div class="flex flex-col gap-2">
                    ...
                    <div class="w-full grid grid-cols-12 px-4 gap-3">
                        ...
                        <div class="col-span-12 md:col-span-12 lg:col-span-12">
                            <label for="bpdp"
                                class="block text-sm font-medium mb-2 {{ $errors->has('state.bpdp') ? 'text-red-500' : '' }}">
                                Bukti Pembayaran / Daftar Penerima :
                            </label>
                            <div class="relative">
                                <input type="file" wire:model="state.bpdp" id="bpdp" name="bpdp"
                                    class="w-full file-input @error('state.bpdp') file-input-error @enderror"
                                    aria-describedby="bpdp-helper"
                                    placeholder="Masukan Bukti Pembayaran / Daftar Penerima..." autocomplete="false"
                                    accept=".jpg,.jpeg,.png,.pdf">
                                <div
                                    class="absolute inset-y-0 end-0 {{ $errors->has('state.bpdp') ? 'flex' : 'hidden' }} items-center pointer-events-none pe-3">
                                    <svg class="shrink-0 size-4 text-red-500" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                            ...
                            <div wire:loading wire:target="state.bpdp" class="text-sm text-blue-500 mt-1">
                                Mengunggah file...
                            </div>
                            @error('state.bpdp')
                                <p class="text-xs text-red-600 mt-1" id="bpdp-helper">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
