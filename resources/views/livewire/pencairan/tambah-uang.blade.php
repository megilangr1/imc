<div class="flex flex-col gap-3">
    <x-main.page-header
        title="Formulir Permohonan Pengajuan Pencairan - Tambah Uang (TU) | {{ isset($editData) ? 'Ubah Data' : 'Tambah Data' }}">
    ...
    <div class="card border border-slate-300 bg-base-100 w-full">
        <div class="card-body p-0 gap-0">
            ...
            <div class="card-actions text-xs font-semibold text-slate-600 bg-slate-200 rounded-b-lg px-5 py-2">
                Formulir Permohonan Pengajuan Pencairan - Tambah Uang (TU) |
