<div class="flex flex-col gap-3">
    ...
    <form wire:submit.prevent="actionForm" id="formVerifikasi" class="w-full">
        <div class="card border border-slate-300 bg-base-100 w-full">
            <div class="card-body p-0 gap-0">
                <div
                    class="card-title px-5 py-3 border-b border-b-slate-300 text-sm flex flex-col md:flex-row items-center justify-between gap-1">
                ...
                @if ($detailData->status === 1)
                    ...
                    <div class="grid grid-cols-12 gap-3 text-sm md:text-sm px-5 py-3">
                        <div class="col-span-12 md:col-span-12 lg:col-span-12">
                            <label for="hasilVerifikasi"
                                class="block text-sm font-medium mb-2 {{ $errors->has('hasilVerifikasi') ? 'text-red-500' : '' }}">
                                Hasil Verifikasi :
                            </label>
                            <div class="relative">
                                <select wire:model="hasilVerifikasi" id="hasilVerifikasi" name="hasilVerifikasi"
                                    class="w-full select @error('hasilVerifikasi') select-error @enderror"
                                    aria-describedby="hasilVerifikasi-helper" placeholder="Masukan hasilVerifikasi..."
                                ...
                                <div
                                    class="absolute inset-y-0 end-6 {{ $errors->has('hasilVerifikasi') ? 'flex' : 'hidden' }} items-center pointer-events-none pe-3">
                            ...
                            @error('hasilVerifikasi')
                                <p class="text-xs text-red-600 mt-1" id="hasilVerifikasi-helper">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-12">
                            <label for="catatanVerifikasi"
                                class="block text-sm font-medium mb-2 {{ $errors->has('catatanVerifikasi') ? 'text-red-500' : '' }}">
                                Catatan Verifikasi :
                            </label>
                            <div class="relative">
                                <textarea type="text" wire:model="catatanVerifikasi" id="catatanVerifikasi" name="catatanVerifikasi"
                                    class="w-full textarea @error('catatanVerifikasi') textarea-error @enderror"
                                    aria-describedby="catatanVerifikasi-helper" placeholder="Masukan Catatan Verifikasi..." autocomplete="false"
                                    required wire:loading.attr="disabled"></textarea>
                                <div
                                    class="absolute inset-y-0 end-0 {{ $errors->has('catatanVerifikasi') ? 'flex' : 'hidden' }} items-center pointer-events-none pe-3">
                                    <svg class="shrink-0 size-4 text-red-500" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                            ...
                            @error('catatanVerifikasi')
                                <p class="text-xs text-red-600 mt-1" id="catatanVerifikasi-helper">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-12 lg:col-span-12 flex flex-col gap-1">
                            <button type="button"
                                ...
                                data-target="verifikasi.main-detail">
    ...
    <script>
        waitForLivewireReady(() => {
            document.addEventListener('click', (e) => {
                ...
                const form = document.querySelector('#formVerifikasi');
                if (!form) return;
                ...
                doSwal(() => {
                    ...
                    text: "Informasi Verifikasi Akan di-Simpan!",
                    icon: "question",
